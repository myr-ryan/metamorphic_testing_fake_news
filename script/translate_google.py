...
from translation_tools.conf.augment_constant import language_short_google
from translation_tools.utils.text_tools import judge_translate_english
...
class GoogleToken:
    ...
    def get_google_token(self, text):
        ...
        :return: 
        """
        #return 'AIzaSyBZZ7tN83YYztM8KH9t6CH1YRQVcnnX6Ec'
...
def any_to_any_translate(content, google_tokn, from_='en', to_='zh-CN'):
    """
       自定义选择
...
def any_to_any_translate_back(content, google_tokn, from_='en', to_='zh-CN'):
    """
      中英，英中回译
    :param content:str, 4891个字， 用户输入 
    :param from_: str, original language
    ...
    :return: str, result of translate
    """
    translate_content = any_to_any_translate(content, google_tokn, from_=from_, to_=to_)
    result = any_to_any_translate(translate_content, google_tokn, from_=to_, to_=from_)
    return result
