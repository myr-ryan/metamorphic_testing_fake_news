...
def MR_2(browser):
	metamorphic_testing(browser, '../reason_lists.csv', '../antonymy_new.csv')
	...
	# 								lemma = True
	# 								#j += 1
	# 							elif (str(doc[first_verb])[-3:] == 'ing'):
	# 								new_s = new_s + ' ' + str(doc[first_subj])
	# 								is_add_not = True
	# 							else:
	# 								#print(str(doc[first_verb])[-3:])
	...
	# 	'Labels': np.nan
	# 	})
	# final.to_csv('../antonymy_new.csv', encoding='utf-8')
